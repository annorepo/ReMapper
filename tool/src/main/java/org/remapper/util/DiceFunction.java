...
public class DiceFunction {
    ...
    public static double calculateDice(InternalNode internalBefore, InternalNode internalCurrent, MatchPair matchPair) {
    ...
    public static double calculateReference(DeclarationNodeTree dntBefore, DeclarationNodeTree dntCurrent, MatchPair matchPair) {
    ...
    public static double calculateSimilarity(DeclarationNodeTree dntBefore, DeclarationNodeTree dntCurrent, MatchPair matchPair) {
        double descendants = 0.0;
        if (dntBefore instanceof InternalNode && dntCurrent instanceof InternalNode)
            descendants = calculateDice((InternalNode) dntBefore, (InternalNode) dntCurrent, matchPair);
        ...
        double dependencies = calculateReference(dntBefore, dntCurrent, matchPair);
