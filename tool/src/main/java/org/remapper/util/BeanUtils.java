...
public class BeanUtils {
    ...
    public static void copyProperties1(Set<Pair<org.refactoringminer.api.EntityInfo, org.refactoringminer.api.EntityInfo>> source,
    ...
    public static void copyProperties(Set<Pair<EntityInfo, EntityInfo>> source,
                                      Set<Pair<EntityComparator, EntityComparator>> target) {
    ...
    private static EntityComparator copyProperties(org.refactoringminer.api.EntityInfo source) {
        ...
        target.setType(source.getLabel().getName());
