                ...
                public void handle(String commitId, MatchPair matchPair) {
                    ...
                    for (Pair<DeclarationNodeTree, DeclarationNodeTree> pair : matchedEntities) {
                        ...
                        if (left.getType() == EntityType.METHOD && right.getType() == EntityType.METHOD &&
                                (StringUtils.compare(left.getNamespace(), right.getNamespace()) || matchedEntities.contains(namespace))) {
                            ...
                            // 1. Rename Method
                            if (!StringUtils.compare(leftDeclaration.getName().getFullyQualifiedName(), rightDeclaration.getName().getFullyQualifiedName())) {
                            ...
                            if (leftDeclaration.getReturnType2() != null && rightDeclaration.getReturnType2() != null &&
                                    !StringUtils.compare(leftDeclaration.getReturnType2().toString(), rightDeclaration.getReturnType2().toString())) {
                            ...
                            // 3. Rename Attribute
                            if (!StringUtils.compare(leftFragment.getName().getFullyQualifiedName(), rightFragment.getName().getFullyQualifiedName())) {
                            ...
                            if (!StringUtils.compare(leftDeclaration.getType().toString(), rightDeclaration.getType().toString())) {
                            ...
                            // 5. Rename Class
                            if (!StringUtils.compare(leftDeclaration.getName().getFullyQualifiedName(), rightDeclaration.getName().getFullyQualifiedName()) &&
                                    StringUtils.compare(left.getNamespace(), right.getNamespace())) {
                            ...
                            // 6. Move Class
                            if (!StringUtils.compare(left.getNamespace(), right.getNamespace()) &&
                                    !matchedEntities.contains(Pair.of(left.getParent(), right.getParent())) &&
                                    StringUtils.compare(leftDeclaration.getName().getFullyQualifiedName(), rightDeclaration.getName().getFullyQualifiedName())) {
                    ...
                    for (DeclarationNodeTree entity : addedEntities) {
                        if (entity.getType() == EntityType.METHOD) {
                            ...
                            for (Pair<DeclarationNodeTree, DeclarationNodeTree> pair : matchedEntities) {
                                ...
                                DeclarationNodeTree right = pair.getRight();
                                // 7. Extract Method
                                if (right.getType() == EntityType.METHOD && StringUtils.compare(left.getNamespace(), entity.getNamespace())) {
                    ...
                    for (DeclarationNodeTree entity : deletedEntities) {
                        if (entity.getType() == EntityType.METHOD) {
                            ...
                            for (Pair<DeclarationNodeTree, DeclarationNodeTree> pair : matchedEntities) {
                                ...
                                DeclarationNodeTree right = pair.getRight();
                                // 9. Inline Method
                                if (left.getType() == EntityType.METHOD && StringUtils.compare(right.getNamespace(), entity.getNamespace())) {
    ...
    private boolean isSubType(TypeDeclaration node1, TypeDeclaration node2) {
        ...
        if (binding != null) {
            if (binding.getSuperclass() != null && binding.getSuperclass().getTypeDeclaration() != null)
                return StringUtils.compare(binding.getSuperclass().getTypeDeclaration().getName(), node2.getName().getFullyQualifiedName());
        }
        ...
        if (superclassType.isParameterizedType()) {
            ...
            return StringUtils.compare(name, node2.getName().getFullyQualifiedName());
        } else
            return StringUtils.compare(superclassType.toString(), node2.getName().getFullyQualifiedName());
    }
}
