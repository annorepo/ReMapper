...
public class EntityMatchingExperimentStarter {
    ...
    public static void main(String[] args) {
        ...
        for (String projectName : projects) {
            new EntityMatchingExperimentStarter().start(datasetPath, projectName);
        }
    }
    ...
    private void start(String datasetPath, String projectName) {
        ...
        try {
            ...
            while ((commitId = reader.readLine()) != null) {
                entityMatcher(datasetPath, projectName, commitId);
            }
            reader.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void entityMatcher(String datasetPath, String projectName, String commitId) throws Exception {
        ...
        BeanUtils.copyProperties1(rMatcher, baseline);
        BeanUtils.copyProperties(reMapper, ourApproach);
