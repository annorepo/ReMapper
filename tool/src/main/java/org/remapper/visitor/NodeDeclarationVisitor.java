...
public class NodeDeclarationVisitor extends ASTVisitor {
    ...
    private final List<AnnotationTypeMemberDeclaration> typeMemberDeclarations;
    ...
    public NodeDeclarationVisitor() {
        ...
        typeMemberDeclarations = new ArrayList<>();
    ...
    public List<AnnotationTypeMemberDeclaration> getTypeMemberDeclarations() {
        return typeMemberDeclarations;
    }
    ...
    public boolean visit(AnnotationTypeMemberDeclaration node) {
        ...
        if (parent instanceof AnnotationTypeDeclaration) {
            ...
            ITypeBinding declaringClass = methodBinding.getDeclaringClass();
            if (declaringClass == null) return true;
            typeMemberDeclarations.add(node);
        }
        return false;
    }
