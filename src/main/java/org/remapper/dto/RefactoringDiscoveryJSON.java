...
public class RefactoringDiscoveryJSON {
    ...
    public void populateJSON(String repository, String sha1, String url, List<org.remapper.diff.Refactoring> refactorings) {
        Result result = new Result(repository, sha1, url, refactorings);
        for (org.remapper.diff.Refactoring refactoring : refactorings) {
    ...
    class Result {
        ...
        public Result(String repository, String sha1, String url, List<org.remapper.diff.Refactoring> refactorings) {
