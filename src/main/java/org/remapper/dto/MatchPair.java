...
public class MatchPair {
    ...
    public Set<EntityInfo> getDeletedEntityInfos() {
        return deletedEntities.stream().map(DeclarationNodeTree::getEntity).collect(Collectors.toSet());
    }
    ...
    public Set<EntityInfo> getAddedEntityInfos() {
        return addedEntities.stream().map(DeclarationNodeTree::getEntity).collect(Collectors.toSet());
    }
