...
public abstract class DeclarationNodeTree {
    ...
    public void addChildren(DeclarationNodeTree node) {
        children.add(node);
    }
    ...
    public EntityInfo getEntityWithFilePath() {
        if (entity != null) {
            entity.setFilePath(location.getFilePath());
            return entity;
        } else
            return getEntity();
    }
    ...
    public EntityInfo getEntity() {
        ...
        if (type == EntityType.METHOD) {
            ...
            entity.setLocationInfo(location);
    ...
    public boolean equals(DeclarationNodeTree other) {
        return this.type == other.type &&
                StringUtils.compare(this.namespace, other.namespace) &&
    ...
    public boolean equals(DeclarationNodeTree other, String filePath, String renamedFilePath) {
        ...
        return this.type == other.type &&
                StringUtils.compare(this.namespace.replace(originalPackage, renamedPackage).replace(originalName, renamedName), other.namespace) &&
                StringUtils.compare(this.name.replace(originalName, renamedName), other.name);
    }
