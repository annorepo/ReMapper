    ...
    public static boolean isGetter(MethodDeclaration methodDeclaration, String field) {
        ...
        if (body != null) {
            ...
            if (statements.size() == 1 && parameters.size() == 0) {
                ...
                return StringUtils.compare(statement.toString(), "return " + field + ";") ||
                        StringUtils.compare(statement.toString(), "return this." + field + ";");
            }
        }
        return false;
    }
    ...
    public static boolean isSetter(MethodDeclaration methodDeclaration, String field) {
        ...
        if (body != null && parameters.size() == 1) {
            ...
            if (statements.size() == 1 && parameters.size() == 1) {
                Statement statement = statements.get(0);
                return StringUtils.compare(statement.toString(), field + "=" + parameters.get(0).getName().getFullyQualifiedName() + ";") ||
                        StringUtils.compare(statement.toString(), "this." + field + "=" + parameters.get(0).getName().getFullyQualifiedName() + ";");
            }
        }
        return false;
    }
