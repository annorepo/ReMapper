...
public class RefactoringDiscoveryExperimentStarter {
    ...
    public static void main(String[] args) {
        ...
        String datasetPath = "/home/remapper/dataset/";
        ...
        for (String projectName : projects) {
            new RefactoringDiscoveryExperimentStarter().start(datasetPath, projectName);
        }
    }
    ...
    private void start(String datasetPath, String projectName) {
        ...
        try {
            ...
            while ((commitId = reader.readLine()) != null) {
                refactoringDiscover(datasetPath, projectName, commitId);
            }
            reader.close();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void refactoringDiscover(String datasetPath, String projectName, String commitId) throws Exception {
        ...
        List<Refactoring> reMapper = new ReMapperPlus().discover(projectPath, commitId);
        ...
        if (file.exists()) {
            ...
            results.populateJSON(remote_repo, commitId, remote_url, rMiner, reMapper);
